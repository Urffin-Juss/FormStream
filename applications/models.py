...
class Application(models.Model):
    ...
    kpp = models.CharField(max_length=9, blank=False, null=False)
    ...
    gps_coordinates = models.CharField(blank=False, null=False, max_length=255)
    ...
    geo_check_status = models.CharField(default="new", max_length=255, choices=STATUS_CHOICES)
